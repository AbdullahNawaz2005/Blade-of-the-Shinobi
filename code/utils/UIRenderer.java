...
/**
 * UI Rendering utilities for consistent visual style across menus
 * Provides helpers for cards, text effects, decorative elements
 * 
 * Converted to use Raylib instead of Graphics2D
 */
public class UIRenderer {
    
    // Color constants for UI (as int arrays [R, G, B, A])
    public static final int[] COLOR_CARD_DEFAULT = {13, 27, 42, 255};       // #0D1B2A dark navy
    public static final int[] COLOR_CARD_SELECTED = {107, 15, 26, 255};     // #6B0F1A deep crimson
    public static final int[] COLOR_STROKE_DEFAULT = {139, 105, 20, 255};   // #8B6914 dark gold
    public static final int[] COLOR_STROKE_SELECTED = {255, 215, 0, 255};   // #FFD700 bright gold
    public static final int[] COLOR_TITLE = {245, 230, 200, 255};           // #F5E6C8 warm off-Colors.WHITE
    public static final int[] COLOR_SUBTITLE = {201, 168, 76, 255};         // #C9A84C muted gold
    public static final int[] COLOR_MUTED_GRAY = {102, 102, 136, 255};      // #666688
    
    // Difficulty colors
    public static final int[] COLOR_EASY = {76, 175, 80, 255};              // #4CAF50 lime Colors.GREEN
    public static final int[] COLOR_NORMAL = {255, 193, 7, 255};            // #FFC107 amber
    public static final int[] COLOR_HARD = {244, 67, 54, 255};              // #F44336 crimson
    
    /**
     * Draw a styled menu card with optional selection state
     */
    public static void drawRoundCard(int x, int y, int w, int h,
                                     boolean selected, String label, float scale) {
        // Apply scale by adjusting position and size
        if (scale != 1.0f) {
    ...
    /**
     * Draw a difficulty card with colored difficulty indicator
     */
    public static void drawDifficultyCard(int x, int y, int w, int h,
        ...
        // Draw difficulty name in its color
    ...
    /**
     * Draw a decorative gold horizontal divider with diamond endpoints
     */
    ...
    /**
     * Draw a katana graphic (blade with guard and handle)
     */
    public static void drawKatana(int centerX, int y, int length) {
        ...
        // Handle (tsuka) - dark Colors.RED wrap
    ...
    /**
     * Draw crossed kunai decoration
     */
    public static void drawCrossedKunai(int centerX, int y) {
        // Draw two kunai rotated (simplified without rotation since Raylib doesn't have easy transforms)
    ...
    /**
     * Draw the HUD info panel at top center
     */
