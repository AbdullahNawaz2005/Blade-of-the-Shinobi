...
public class Constants {
    ...
    public static final double TARGET_TIME = 1000000000.0 / TARGET_FPS; 
    ...
    public static final double COMBO_TIMEOUT = 2.0; 
    ...
    public static final Platform[] PLATFORMS = {
        new Platform(420, 480, 180, 20),  
        new Platform(80, 400, 140, 20),   
        new Platform(760, 420, 140, 20)   
    };
